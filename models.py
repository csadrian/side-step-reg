...
def mlp(input_shape, num_classes=10):
    "Build MLP model as in https://arxiv.org/pdf/1810.12488.pdf"
...
@gin.configurable()
def build_model(model_type, depth=14):
